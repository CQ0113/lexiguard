...
class LegalTemplateLibraryPage extends StatefulWidget {
  ...
  @override
  State<LegalTemplateLibraryPage> createState() => _LegalTemplateLibraryPageState();
}
  ...
  final List<Map<String, dynamic>> _templates = [
    {
      ...
      "category": "Property",
      "dynamic_fields": [
        {"field_id": "f_landlord_name", "label": "Landlord's Full Name (as per NRIC/Passport)", "type": "string", "required": true},
        {"field_id": "f_landlord_ic", "label": "Landlord's NRIC or Passport Number", "type": "string", "required": true},
        {"field_id": "f_tenant_name", "label": "Tenant's Full Name (as per NRIC/Passport)", "type": "string", "required": true},
        {"field_id": "f_tenant_ic", "label": "Tenant's NRIC or Passport Number", "type": "string", "required": true},
        {"field_id": "f_property_address", "label": "Full Address of the Demised Premises", "type": "string", "required": true},
        {"field_id": "f_monthly_rental", "label": "Monthly Rental Amount in Ringgit Malaysia (RM)", "type": "number", "required": true},
        {"field_id": "f_security_deposit", "label": "Security Deposit Amount in Ringgit Malaysia (RM)", "type": "number", "required": true},
        {"field_id": "f_utility_deposit", "label": "Utility Deposit Amount in Ringgit Malaysia (RM)", "type": "number", "required": true},
        {"field_id": "f_commencement_date", "label": "Tenancy Commencement Date (DD/MM/YYYY)", "type": "date", "required": true},
        {"field_id": "f_tenancy_duration", "label": "Tenancy Period (in months, e.g., 12 or 24)", "type": "number", "required": true}
      ],
    ...
    },
    {
      ...
      "category": "Corporate",
      "dynamic_fields": [
        {"field_id": "f_party1_name", "label": "First Party's Full Name / Company Name", "type": "string", "required": true},
        {"field_id": "f_party1_reg", "label": "First Party's Company Registration Number / NRIC", "type": "string", "required": true},
        {"field_id": "f_party2_name", "label": "Second Party's Full Name / Company Name", "type": "string", "required": true},
        {"field_id": "f_party2_reg", "label": "Second Party's Company Registration Number / NRIC", "type": "string", "required": true},
        {"field_id": "f_effective_date", "label": "Effective Date of the Agreement", "type": "date", "required": true},
        {"field_id": "f_duration_years", "label": "Duration of Confidentiality Obligations (in years)", "type": "number", "required": true}
      ],
    ...
    },
    {
      ...
      "category": "Dispute",
      "dynamic_fields": [
        {"field_id": "f_creditor_name", "label": "Creditor's Full Name / Company Name", "type": "string", "required": true},
        {"field_id": "f_debtor_name", "label": "Debtor's Full Name / Company Name", "type": "string", "required": true},
        {"field_id": "f_debtor_address", "label": "Debtor's Full Address", "type": "string", "required": true},
        {"field_id": "f_debt_amount", "label": "Total Outstanding Amount (RM)", "type": "number", "required": true},
        {"field_id": "f_due_date", "label": "Original Date the Debt was Due", "type": "date", "required": true},
        {"field_id": "f_grace_period_days", "label": "Grace Period for Payment (in days)", "type": "number", "required": true}
      ],
    ...
    },
    {
      ...
      "category": "Employment",
      "dynamic_fields": [
        {"field_id": "f_employer_name", "label": "Employer's Company Name", "type": "string", "required": true},
        {"field_id": "f_employee_name", "label": "Employee's Full Name (as per NRIC/Passport)", "type": "string", "required": true},
        {"field_id": "f_employee_ic", "label": "Employee's NRIC / Passport Number", "type": "string", "required": true},
        {"field_id": "f_job_title", "label": "Job Title", "type": "string", "required": true},
        {"field_id": "f_salary", "label": "Monthly Base Salary (RM)", "type": "number", "required": true},
        {"field_id": "f_start_date", "label": "Commencement Date of Employment", "type": "date", "required": true}
      ],
    ...
    },
    {
      ...
      "category": "Corporate",
      "dynamic_fields": [
        {"field_id": "f_client_name", "label": "Client's Company Name", "type": "string", "required": true},
        {"field_id": "f_consultant_name", "label": "Consultant's Name / Company Name", "type": "string", "required": true},
        {"field_id": "f_services_desc", "label": "Detailed Description of Services", "type": "string", "required": true},
        {"field_id": "f_consulting_fee", "label": "Consulting Fee Amount (RM)", "type": "number", "required": true},
        {"field_id": "f_payment_terms", "label": "Payment Term Conditions (e.g. within 14 days of invoice)", "type": "string", "required": true},
        {"field_id": "f_start_date", "label": "Agreement Start Date", "type": "date", "required": true}
      ],
    ...
    },
    {
      ...
      "category": "Corporate",
      "dynamic_fields": [
        {"field_id": "f_partner1_name", "label": "First Partner's Full Name (as per NRIC)", "type": "string", "required": true},
        {"field_id": "f_partner2_name", "label": "Second Partner's Full Name (as per NRIC)", "type": "string", "required": true},
        {"field_id": "f_business_name", "label": "Proposed Partnership Business Name", "type": "string", "required": true},
        {"field_id": "f_capital_contribution", "label": "Initial Capital Contribution per Partner (RM)", "type": "number", "required": true},
        {"field_id": "f_profit_share_percent", "label": "Profit and Loss Share Percentage", "type": "number", "required": true},
        {"field_id": "f_start_date", "label": "Partnership Commencement Date", "type": "date", "required": true}
      ],
            ...
            child: filteredTemplates.isEmpty
                ...
                : GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final name = template['template_name'] as String? ?? 'Contract Template';
                      final cat = template['category'] as String? ?? 'General';
                      final fieldsCount = (template['dynamic_fields'] as List? ?? []).length;
                      
                      return GestureDetector(
                        onTap: () {
                          Navigator.of(context).push(
                            MaterialPageRoute(
                              builder: (_) => DynamicLegalFormPage(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Container(
                                decoration: BoxDecoration(
                                  color: _getCategoryColor(cat).withOpacity(0.08),
