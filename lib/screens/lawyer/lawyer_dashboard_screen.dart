...
class _LawyerCRMTab extends StatelessWidget {
  ...
  static const _stats = [
    _Stat('Active Leads', '24', '+3 this week', Icons.group_outlined, Color(0xFF0B2447)),
    _Stat('Pending Docs', '8', '2 urgent', Icons.description_outlined, Color(0xFFD4AF37)),
    _Stat('Revenue (MTD)', 'RM 12.4K', '+18%', Icons.attach_money, Color(0xFF2E8B57)),
    _Stat('Avg Rating', '4.9', '127 reviews', Icons.star_outline, Color(0xFFE6A817)),
  ];

  // Leads from lawyer-dashboard.tsx exactly
  static const _leads = [
    _Lead('Tan Wei Ming', 'Property Dispute — Penang', 'Hot Lead', 'Today', 'high'),
    _Lead('Nurul Izzah', 'Divorce Proceedings', 'Follow Up', 'Yesterday', 'medium'),
    _Lead('Siva a/l Rajan', 'Employment Termination', 'New', '2d ago', 'low'),
    _Lead('Lim Boon Keat', 'Criminal Defense — KL', 'Hot Lead', '3d ago', 'high'),
  ];
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Client revealed their identity',
                          style: GoogleFonts.inter(
                              color: _navy,
                              fontSize: 14,
                              fontWeight: FontWeight.w600)),
                ...
                OutlinedButton(
                  onPressed: () => Navigator.of(context).push(MaterialPageRoute(
                    builder: (_) => CaseDetailScreen(
                        caseModel: c,
                        viewer: DummyData.users
                            .firstWhere((u) => u.role == UserRole.lawyer)),
                  )),
              ...
              children: [
                Text('1 pending request',
                    style: GoogleFonts.inter(
                        ...
                        fontSize: 13,
                        fontWeight: FontWeight.w600)),
                Text('Awaiting client approval to reveal identity',
                    style: GoogleFonts.inter(
...
class _LawyerMyCasesTabState extends State<_LawyerMyCasesTab> {
  ...
  List<CaseModel> get _filtered {
    ...
    return list.where((c) =>
        ...
        c.categoryLabel.toLowerCase().contains(q)).toList();
  }
      ...
      child: Column(
        ...
        children: [
          ...
          Text('My Cases',
              style: GoogleFonts.inter(
                  color: _navy, fontSize: 20, fontWeight: FontWeight.w700)),
          Text('Cases you\'ve expressed interest in or are actively working on',
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('Browse Open Cases',
                          style: GoogleFonts.inter(
                              color: _navy,
                              fontSize: 13,
                              fontWeight: FontWeight.w600)),
                      Text('Find new cases and express interest',
                          style: GoogleFonts.inter(
  ...
  Widget _myCaseCard(BuildContext context, CaseModel c, bool isConnected) {
    ...
    final statusText =
        isConnected ? const Color(0xFF16A34A) : const Color(0xFFD97706);
    final statusLabel = isConnected ? 'CONNECTED' : 'AWAITING';
    final statusIcon =
        isConnected ? Icons.lock_open_outlined : Icons.access_time;
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: statusBg,
                border: Border(
                    bottom: BorderSide(color: statusBorder)),
              ),
              child: Row(
                children: [
